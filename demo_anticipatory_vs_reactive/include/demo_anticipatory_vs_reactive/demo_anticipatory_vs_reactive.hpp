...
namespace demo_anticipatory_vs_reactive
{
    ...
    class DemoAnticipatoryVsReactive
    {

    public:
        explicit DemoAnticipatoryVsReactive(ros::NodeHandle nh);

        ~DemoAnticipatoryVsReactive();
        ...
        void glassesDataCallback(const companion_msgs::GlassesData::ConstPtr &glassesData);
